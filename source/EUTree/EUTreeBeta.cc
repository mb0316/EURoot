...
EUTreeBeta::EUTreeBeta(TTree* tree)
{
	...
	tree -> Branch("ion_E_X", &ion_E_X, "ion_E_X/I");
	tree -> Branch("ion_E_Y", &ion_E_Y, "ion_E_Y/I");
	tree -> Branch("ion_T_X", &ion_T_X, "ion_T_X/I");
	tree -> Branch("ion_T_Y", &ion_T_Y, "ion_T_Y/I");
	tree -> Branch("dssdhit", &dssdhit, "dssdhit/I");
	tree -> Branch("beta_z", &beta_z, "beta_z/I");
	tree -> Branch("beta_x", &beta_x, "beta_x/I");
	tree -> Branch("beta_y", &beta_y, "beta_y/I");
	tree -> Branch("beta_E_X", &beta_E_X, "beta_E_X/I");
	tree -> Branch("beta_E_Y", &beta_E_Y, "beta_E_Y/I");
	tree -> Branch("beta_T_X", &beta_T_X, "beta_T_X/I");
	tree -> Branch("beta_T_Y", &beta_T_Y, "beta_T_Y/I");
