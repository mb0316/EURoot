...
//	TApplication theApp("test",0,0);
	...
	TString filename;
	filename = "../results/BuildIsoDecay/BuildIsoDecay.root";

	TFile* out  = new TFile(Form("../results/PID/Isodecay_%d_%d.root", zpro, mass), "RECREATE");
	TTree* tree = new TTree("tree", "tree");
	EUTreeIso* decay = new EUTreeIso(filename);
	EUAnaIso* pid = new EUAnaIso(tree);
	...
	cvs->SaveAs(Form("../results/PID/Isodecay_%d_%d.pdf", zpro, mass));
//	theApp.Run();
	return 0;
}
